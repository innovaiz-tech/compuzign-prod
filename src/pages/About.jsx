...
export default function About() {
  ...
  return (
    <>
      <SEO
        title="About CompuZign | 25+ Years IT Consulting & SaaS Expertise"
        description="CompuZign provides end-to-end IT solutions including consulting, migration, support, and cyber resilience. Backed by 25+ years of expertise and a proven recovery model."
        keywords="CompuZign, IT consulting, SaaS delivery model, cyber resilience, IT migration, support services"
      />
