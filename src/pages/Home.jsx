...
export default function Home() {
    ...
    return (
        <>
            <SEO
                title="CompuZign | IT Services, SaaS Delivery & Cyber Recovery Solutions"
                description="With over 25 years of expertise, CompuZign delivers IT consulting, SaaS solutions, cyber recovery, migration, and 24/7 ZENfra-powered support to protect and scale your business."
                keywords="IT services, SaaS delivery, cyber recovery, data migration, IT consulting, managed services, ZENfra, CompuZign"
            />
